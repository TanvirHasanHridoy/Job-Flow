          ...
          >
            <div className="flex items-center gap-3 text-left">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400 mt-0.5">Quickly pre-populate your vault using public GitHub repositories or LinkedIn copy-paste details.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
              ...
              <div className="md:col-span-8 flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-zinc-400 uppercase tracking-wider flex items-center gap-1.5">
                  ...
                  LinkedIn Profile / Resume Copy-Paste Text
                </label>
                <textarea
                  value={linkedinText}
            ...
            >
              {importing ? (
                ...
                <>
                  ...
                  Parse Inputs & Pre-populate Editor Tabs
                </>
              )}
            </button>
          </div>
